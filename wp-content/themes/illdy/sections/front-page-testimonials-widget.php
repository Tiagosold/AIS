...
if (isset($_GET['reg'])){
    ...
    <p class="status"></p>
    <input id="password_register" placeholder="Nova Password" type="password" name="password">
    <div id="passwordmsg" style="color:Red; font-size:75%; display:none"></div>
    <input id="confirm_password" placeholder="Confirmar Password" type="password" name="confirm_password">
    <div id="confirmmsg" style="color:Red; font-size:75%; display:none"></div>
...
<div class="select-style">
    ...
    <div id="usermsg" style="color:Red; font-size:75%; display:none"></div>
<p></p>
<div class="select-style">
...
<div class="hidden-div">
    ...
    <div id="quotasmsg" style="color:Red; font-size:75%; display:none"></div>
</div>
